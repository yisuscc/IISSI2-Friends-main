...
const userswithhobbiesAPI_auto = {

    /**
    * Gets all UsersWithHobbies
    */
    getAll: async function(formData) {
        let response = await axios.get(`${BASE_URL}/userswithhobbies`, requestOptions);
        return response.data;
    },
};

export {userswithhobbiesAPI_auto};